...
func (repository *TransactionRepositoryImpl) GetAllTransaction(roleName string, limit int, offset int, dateFrom string, dateTo string, types string, status string) (dto.TransactionWithTotal, error) {
